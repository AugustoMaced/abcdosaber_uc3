...
class Turma(models.Model):
    numero = models.AutoField(primary_key=True,
                               help_text="Informe a turma do Aluno")
    horario_aula = models.TimeField(default=timezone.now(), help_text="Informe a hora em que a hora da aula da Turma")
    duracao_aula = models.SmallIntegerField(default=30,
                                            help_text="Informe a duração da aula da Turma")
    ...
    codigo_atividade = models.ForeignKey(TipoDeAtividade, null=True, on_delete=models.CASCADE)
